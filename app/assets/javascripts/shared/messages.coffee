set_chat = (name) -> # coloca o nome do canal ou do user em cima da box de texto
    $(".chat_name").html(name)

clean_messages = () -> # limpa a tela de texto
    $(".messages").html("")
    $(".chat_name").html("")

add_message = (message, message_date, name) -> # coloca o html avatar, nome, data e texto
